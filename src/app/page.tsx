...
export default function Home() {
  ...
  return (
    <main
      ref={mainRef}
      className={`flex-1 flex h-full overflow-hidden bg-[#f8f9fa] text-[#191c1d] antialiased font-sans ${
        isResizingList || isResizingDetails
    ...
    >
      ...
      {listMode !== "closed" && (
        <div
          ...
          className="shrink-0 flex flex-col h-full border-r border-[#e1e3e4] transition-all duration-300 relative"
        >
          <ConversationList
      ...
      {/* Main Center Pane: Chat Window & Right Drawer: Contact Details */}
            ...
            {!isDetailsCollapsed && (
              <>
                ...
                <div
                  ...
                  className="shrink-0 flex flex-col h-full bg-[#f3f4f5] overflow-hidden relative"
                >
                  <ContactDetails
